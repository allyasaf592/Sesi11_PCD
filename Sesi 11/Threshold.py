...
print("Analisis Hasil Output:")
print("1. Gambar asli menunjukkan detail yang jelas dari objek.")
print("2. Gambar deteksi tepi menggunakan Sobel menyoroti tepi objek dengan baik.")
print("3. Hasil segmentasi citra menunjukkan area yang lebih terang sebagai objek yang terdeteksi,")
print("   sementara area yang lebih gelap menunjukkan latar belakang atau area yang tidak relevan.")
print("4. Pengaturan parameter block_size dan c pada fungsi local_thres dapat mempengaruhi hasil segmentasi.")
print("   Nilai yang lebih besar untuk block_size dapat menghasilkan segmentasi yang lebih halus,")
print("   sedangkan nilai c yang lebih tinggi dapat mengurangi noise.")